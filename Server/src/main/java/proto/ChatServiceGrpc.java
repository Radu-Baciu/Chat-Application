...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Chat.ChatMessage,
      proto.Chat.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = proto.Chat.ChatMessage.class,
      responseType = proto.Chat.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<proto.Chat.ChatMessage,
      proto.Chat.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<proto.Chat.ChatMessage, proto.Chat.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<proto.Chat.ChatMessage, proto.Chat.ChatMessageFromServer>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Chat.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<proto.Chat.ChatMessage> chat(
        io.grpc.stub.StreamObserver<proto.Chat.ChatMessageFromServer> responseObserver) {
          ...
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                ...
                proto.Chat.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
