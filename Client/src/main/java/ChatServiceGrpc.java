...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Chat.ChatMessage,
      Chat.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = Chat.ChatMessage.class,
      responseType = Chat.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<Chat.ChatMessage,
      Chat.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<Chat.ChatMessage, Chat.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<Chat.ChatMessage, Chat.ChatMessageFromServer>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Chat.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<Chat.ChatMessage> chat(
        io.grpc.stub.StreamObserver<Chat.ChatMessageFromServer> responseObserver) {
