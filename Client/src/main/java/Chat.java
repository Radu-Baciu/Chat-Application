...
public final class Chat {
  ...
  public interface ChatMessageFromServerOrBuilder extends
     ...
     * <code>.ChatMessage message = 1;</code>
     */
    Chat.ChatMessageOrBuilder getMessageOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              Chat.ChatMessage.Builder subBuilder = null;
              if (message_ != null) {
                subBuilder = message_.toBuilder();
              }
              message_ = input.readMessage(Chat.ChatMessage.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Chat.internal_static_ChatMessageFromServer_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Chat.internal_static_ChatMessageFromServer_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Chat.ChatMessageFromServer.class, Chat.ChatMessageFromServer.Builder.class);
    }

    public static final int MESSAGE_FIELD_NUMBER = 1;
    private Chat.ChatMessage message_;
    /**
     * <code>.ChatMessage message = 1;</code>
     */
    ...
    public Chat.ChatMessage getMessage() {
      return message_ == null ? Chat.ChatMessage.getDefaultInstance() : message_;
    }
    /**
     * <code>.ChatMessage message = 1;</code>
     */
    public Chat.ChatMessageOrBuilder getMessageOrBuilder() {
      return getMessage();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Chat.ChatMessageFromServer)) {
        return super.equals(obj);
      }
      Chat.ChatMessageFromServer other = (Chat.ChatMessageFromServer) obj;
    ...
    public static Chat.ChatMessageFromServer parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Chat.ChatMessageFromServer parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Chat.ChatMessageFromServer parseFrom(
    ...
    public static Chat.ChatMessageFromServer parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Chat.ChatMessageFromServer parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Chat.ChatMessageFromServer parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Chat.ChatMessageFromServer prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        Chat.ChatMessageFromServerOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Chat.internal_static_ChatMessageFromServer_descriptor;
      }
      ...
      // Construct using Chat.ChatMessageFromServer.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public Chat.ChatMessageFromServer getDefaultInstanceForType() {
        return Chat.ChatMessageFromServer.getDefaultInstance();
      }

      @java.lang.Override
      public Chat.ChatMessageFromServer build() {
        Chat.ChatMessageFromServer result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public Chat.ChatMessageFromServer buildPartial() {
        Chat.ChatMessageFromServer result = new Chat.ChatMessageFromServer(this);
        if (messageBuilder_ == null) {
          result.message_ = message_;
        } else {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Chat.ChatMessageFromServer) {
          return mergeFrom((Chat.ChatMessageFromServer)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Chat.ChatMessageFromServer other) {
        if (other == Chat.ChatMessageFromServer.getDefaultInstance()) return this;
        if (other.hasMessage()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Chat.ChatMessageFromServer parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Chat.ChatMessageFromServer) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private Chat.ChatMessage message_ = null;
      private com.google.protobuf.SingleFieldBuilderV3<
          Chat.ChatMessage, Chat.ChatMessage.Builder, Chat.ChatMessageOrBuilder> messageBuilder_;
      /**
       * <code>.ChatMessage message = 1;</code>
       */
      public boolean hasMessage() {
       ...
       * <code>.ChatMessage message = 1;</code>
       */
      public Builder setMessage(Chat.ChatMessage value) {
        if (messageBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setMessage(
          Chat.ChatMessage.Builder builderForValue) {
        if (messageBuilder_ == null) {
       ...
       * <code>.ChatMessage message = 1;</code>
       */
      public Builder mergeMessage(Chat.ChatMessage value) {
        if (messageBuilder_ == null) {
          if (message_ != null) {
            message_ =
              Chat.ChatMessage.newBuilder(message_).mergeFrom(value).buildPartial();
          } else {
            message_ = value;
          }
          onChanged();
       ...
       * <code>.ChatMessage message = 1;</code>
       */
      public Chat.ChatMessage.Builder getMessageBuilder() {
      ...
      public Chat.ChatMessageOrBuilder getMessageOrBuilder() {
        if (messageBuilder_ != null) {
          ...
          return message_ == null ?
              Chat.ChatMessage.getDefaultInstance() : message_;
        }
      }
      /**
       * <code>.ChatMessage message = 1;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          Chat.ChatMessage, Chat.ChatMessage.Builder, Chat.ChatMessageOrBuilder> 
    ...
    private static final Chat.ChatMessageFromServer DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Chat.ChatMessageFromServer();
    }

    public static Chat.ChatMessageFromServer getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ssageFromServer\"\000(\0010\001b\006proto3"
    };
